<template>
  <div class="border border-gray-200 bg-gray-200 rounded-lg shadow-lg">
    <div
      class="px-4 pb-2 pt-1 border border-l-0 border-t-0 border-r-0 border-gray-400"
    >
      <a
    ...
    <div class="p-4 mt-2 text-gray-600">
      ...
      <div class="mt-5 flex flex-wrap md:w-10/12 md:mx-auto">
        ...
        <div
          class="px-2 flex-1 flex items-center justify-start whitespace-no-wrap"
        >
    ...
    updatedStr(): string {
      ...
      if (hours < 1) return 'recently'
        ...
        return `${Math.round(hours)} ${
          Math.round(hours) === 1 ? 'hour' : 'hours'
        } ago`
      else if (months < 1)
        return `${Math.round(days)} ${
          Math.round(days) === 1 ? 'day' : 'days'
        } ago`
      else if (years < 1)
